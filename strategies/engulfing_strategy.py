...
def compute_engulfing_signal(candles):
    ...
    Filters:- Skip if last 4 candles are alternating (sideways market), - Skip if engulfing candle has very long wicks (weak conviction)
    """
    if len(candles) < 3:
